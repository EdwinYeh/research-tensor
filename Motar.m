...
%                 dif(1) = difVector'* difVector;
    ...
    if isURandom == true
        for t = 1: randomTryTime
            [initU(t,:),initB{t},initV(t,:)] = randomInitialize(Y, numInstance, numFeature, numInstanceCluster, numFeatureCluster, numDom, true);
        end
    end
