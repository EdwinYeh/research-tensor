...
load('dataset1_idx.mat');

parallel_k=1;
sampleSourceDataIndex=sourceIdx(parallel_k*500+1:(parallel_k+1)*500);
sampleValidateDataIndex=targetIdx(parallel_k*600+1:(parallel_k)*600+100);
sampleTestDataIndex=targetIdx((parallel_k)*600+101:(parallel_k+1)*600);
