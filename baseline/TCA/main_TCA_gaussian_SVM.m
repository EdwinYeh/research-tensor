...
%     [~, avgEmpError, validationAccuracy] = trainAndCvGaussianTCA(mu, sigma, numFold, numSourceData, numValidateData, -1, featureDimAfterReduce, sourceDomainData, targetDomainData, Y, false);
...
[predictLabel, avgEmpError, accuracy] = trainAndCvGaussianTCA(bestMu, bestSigma, 1, numSourceData, numValidateData, numTestData, featureDimAfterReduce, sourceDomainData, [targetDomainData; testData], Y, true); 
