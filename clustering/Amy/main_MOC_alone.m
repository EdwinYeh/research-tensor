...
for i=fromUser:toUser
    disp([datasetName ' MOC alone start from user: ' num2str(fromUser)]);
    i
    ...
    for seedSetCount=1:seedSetNum
        ...
        for initIdx=1:initIterNum
            try
                clustering = seedMOC(augmentX', k, S'); %return k*n
        ...
        save([outputPath datasetName num2str(fromUser) '-' num2str(toUser) '_MOC_alone_recall_precision.mat'], 'recall','filterPrecision','FScore','clusteringResult');
