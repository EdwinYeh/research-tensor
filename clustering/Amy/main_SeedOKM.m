...
for i=fromUser:toUser
    ...
    for seedSetCount=1:seedSetNum
        ...
        for paramCount=1:diffParamNum
            ...
            for initIdx=1:initIterNum
                try
                clustering = seedOKM(userDataMat{i}{paramCount,2},k,S',0.0001); %return k*n
    ...
    save([outputPath algoResultMat '_SeedOKM_recall_precision.mat'], 'recallsOfBestFScore','precisionsOfBestFScore', 'recall','filterPrecision','FScore', 'bestFScore','bestParameter','clusteringResult');
end
