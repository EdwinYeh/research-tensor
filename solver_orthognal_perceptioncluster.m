function [output]=solver_mturk(input,hyperparam)
% Input variable:
...
A = randi(10,hyperparam.perceptionClusterNum,hyperparam.cpRank);
E=cell(domainNum,1);
W=cell(domainNum,1);
XW=cell(domainNum,1);
U = cell(domainNum,1);
...
for domId = 1:domainNum
    ...
    U{domId} = randi(10, perceptionNumList(domId), hyperparam.perceptionClusterNum);
